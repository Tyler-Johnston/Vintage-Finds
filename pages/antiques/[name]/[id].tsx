            ...
            {antique ? (
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div>
                        ...
                        <p>best value cost: ${shipmentData ? shipmentData.rates[BESTVALUE].amount : 'X'}
                        and will take {shipmentData ? shipmentData.rates[BESTVALUE].estimated_days
                        : 'unknown'} days to arrive</p> */}
                    </div>
                </div>
            )
            : (
